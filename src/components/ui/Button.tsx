...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary: 'bg-accent text-accent-fg active:bg-accent-dim',
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  { variant = 'primary', size = 'lg', fullWidth, className, children, disabled, ...props },
  ref,
) {
  return (
    <motion.button
      ...
      disabled={disabled}
      className={cn(
        'inline-flex items-center justify-center gap-2 font-semibold select-none transition-colors duration-150 disabled:opacity-40',
