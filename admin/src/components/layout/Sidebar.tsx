...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'w-[248px] shrink-0 bg-sidebar flex flex-col h-full fixed inset-y-0 left-0 z-50 transition-transform duration-200 lg:static lg:translate-x-0',
      ...
      >
        <div className="flex items-center gap-2 px-5 pt-6 pb-6">
          ...
          <button
            ...
            className="lg:hidden h-7 w-7 rounded-lg flex items-center justify-center text-sidebar-text-muted hover:bg-sidebar-hover transition-colors"
          >
            <X size={16} />
          </button>
        </div>
